...
public class ManageCategory extends javax.swing.JFrame {
 public int categoryPk=0;
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(14, 61, 489, 495));

        nn.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        nn.setText("Name");
        getContentPane().add(nn, new org.netbeans.lib.awtextra.AbsoluteConstraints(521, 87, -1, -1));
        ...
        getContentPane().add(txtName, new org.netbeans.lib.awtextra.AbsoluteConstraints(521, 109, 260, -1));
        ...
        getContentPane().add(btnSave, new org.netbeans.lib.awtextra.AbsoluteConstraints(521, 185, -1, -1));
        ...
        getContentPane().add(btnUpdate, new org.netbeans.lib.awtextra.AbsoluteConstraints(599, 185, -1, -1));
        ...
        getContentPane().add(btnReset, new org.netbeans.lib.awtextra.AbsoluteConstraints(677, 185, -1, -1));
        ...
        getContentPane().add(btnClose, new org.netbeans.lib.awtextra.AbsoluteConstraints(755, 185, -1, -1));
